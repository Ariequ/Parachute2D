...
public class Example : MonoBehaviour {
	...
	void Start () {
        //设置Umeng Appkey
        Social.SetAppKey("507fcab25270157b37000010");
	}
    ...
    void OnGUI()
    {
        ...
        {
            //按需设置您需要的平台
            Platform[] platforms = { Platform.DOUBAN, Platform.INSTAGRAM, Platform.QQ, Platform.WEIXIN, Platform.SINA};
            ...
            //接入微信
            Social.SetWechatAppId("wx967daebe835fbeac");
